...
public class WriteFile {
    ...
    public static boolean writePdf(Pix pixs, File file) {
    	if(pixs == null) {
    		throw new IllegalArgumentException("Source pix must be non-null");
    	}
    	if(file == null) {
    	...
    	return nativeWritePdf(pixs.getNativePix(),
    		 file.getAbsolutePath());
    }
    ...
    private static native boolean nativeWritePdf(long nativePix, String fileName);
