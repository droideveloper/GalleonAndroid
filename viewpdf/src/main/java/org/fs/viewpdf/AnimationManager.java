...
class AnimationManager {
  ...
  public void startFlingAnimation(int startX, int startY, int velocityX, int velocityY, int minX,
  ...
  class XAnimation implements AnimatorUpdateListener {
    ...
    @Override public void onAnimationUpdate(ValueAnimator animation) {
      ...
      if (cached != null) {
        ...
        cached.moveTo(offset, cached.getCurrentYOffset());
      }
    }
  }
  ...
  class YAnimation implements AnimatorUpdateListener {
    ...
    @Override public void onAnimationUpdate(ValueAnimator animation) {
      ...
      if (cached != null) {
        float offset = (Float) animation.getAnimatedValue();
        cached.moveTo(cached.getCurrentXOffset(), offset);
      }
    }
  }
  ...
  class ZoomAnimation implements AnimatorUpdateListener, AnimatorListener {
    ...
    @Override public void onAnimationUpdate(ValueAnimator animation) {
      ...
      if (cached != null) {
        ...
        cached.zoomCenteredTo(zoom, new PointF(centerX, centerY));
      }
    }
  ...
  class FlingAnimation implements AnimatorUpdateListener, AnimatorListener {
    @Override public void onAnimationUpdate(ValueAnimator animation) {
      if (!scroller.isFinished()) {
        ...
        final PDFView cached = getCachedView();
        if (cached != null) {
          cached.moveTo(scroller.getCurrX(), scroller.getCurrY());
  ...
  private void hideHandle() {
    final PDFView cached = getCachedView();
    if (cached != null) {
      if (cached.getScrollHandle() != null) {
