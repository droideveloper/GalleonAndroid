...
import static org.fs.viewpdf.util.Constants.Cache.THUMBNAILS_CACHE_SIZE;
...
class CacheManager {
  ...
  @Nullable private static PagePart find(PriorityQueue<PagePart> vector, PagePart fakePart) {
  ...
  class PagePartComparator implements Comparator<PagePart> {
    @Override public int compare(PagePart part1, PagePart part2) {
