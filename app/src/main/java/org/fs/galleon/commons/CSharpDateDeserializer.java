...
public final class CSharpDateDeserializer implements JsonDeserializer<Date> {

  private final static String FromJsonRegex = "[^0-9]";
  ...
  private Date toDate(String str) {
    return new Date(
      Long.parseLong(
        str.replaceAll(FromJsonRegex, StringUtility.EMPTY)
      )
    );
  }
}
