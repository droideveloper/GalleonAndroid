...
public final class SearchQueryValidator implements IValidator<String> {
  ...
  @Override public ValidationResult<String> validate(String value, Locale currentLocale) {
    return value.length() >= 3 ? new ValidationResult<>(value, ValidationResult.VALID) : ValidationResult.invalid();
  }
}
